...
export default function Navbar() {
  return (
    ...
    <nav className="fixed top-4 left-4 right-4 z-50 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl p-6 w-fit justify-center mx-auto pointer-events-none">
      <div className="pointer-events-auto">
      <ul className="flex justify-center space-x-6 list-none mt-4">
